...
<html lang="en">
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<div class="span12">
					<form role="form" method="post" action="add.php" enctype="multipart/form-data" accept-charset="UTF-8">
						<!--<label>
							Subject: 
						...
						<div class="form-group">
							...
							<label>
								Question Text:<br />
								<textarea class="form-control" name="qtext" rows="5"></textarea>
							</label>
							<label>
								Choice W: 
								<input type="text" class="form-control" name="choicew"></input>
							</label>
							<label>
								Choice X: 
								<input type="text" class="form-control" name="choicex"></input>
							</label>
							<label>
								Choice Y: 
								<input type="text" class="form-control" name="choicey"></input>
							</label>
							<label>
								Choice Z: 
								<input type="text" class="form-control" name="choicez"></input>
							</label>
							<label>
								Answer: 
								<input type="text" class="form-control" name="answer"></input>
							</label>
